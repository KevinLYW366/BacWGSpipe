...
#### Chromosome {.tabset .tabset-dropdown}
...
for (pic in pics) {
  id <- gsub(".png", "", basename(pic))
  cat("##### ", id, " \n")
  cat("\n")
  cat("![](", pic, "){width=60%}", "\n")
  cat("<center>**Figure 2-6 Circos plot of chromosome**</center>", "\n")
  cat("<center>&nbsp;</center>", "\n")
  cat("<center>**Note** Outer to inner tracks mean (1) Forward CDS (2) Reverse CDS (3) rRNA (4) tRNA (5) GC content (6) GC skew, respectively. COG functional classification color is assigned to Forward/Reverse CDS.</center>", "\n")
  cat("<center>&nbsp;</center>", "\n")
  cat("\n")
}
```
...
#### Plasmid {.tabset .tabset-dropdown}
...
for (pic in pics) {
  ...
  cat("\n")
  cat("![](", pic, "){width=60%}", "\n")
  cat("<center>**Figure 2-7 Circos plot of plasmid**</center>", "\n")
  cat("<center>&nbsp;</center>", "\n")
  cat("<center>**Note** Outer to inner tracks mean (1) Forward CDS (2) Reverse CDS (3) rRNA (4) tRNA (5) GC content (6) GC skew, respectively. COG functional classification color is assigned to Forward/Reverse CDS.</center>", "\n")
  cat("<center>&nbsp;</center>", "\n")
  cat("\n")
